...
@OnlyIn(Dist.CLIENT)
public class DoctorNPCEntityModel extends SegmentedModel<DoctorNPCEntity> implements IHasHead {
    ...
    public DoctorNPCEntityModel(float scale) {
        this(scale, 64, 64);
    }

    public DoctorNPCEntityModel(float p_i51059_1_, int p_i51059_2_, int p_i51059_3_) {
        float f = 0.5F;
     ...
     */
    public void setRotationAngles(DoctorNPCEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        boolean flag = false;
